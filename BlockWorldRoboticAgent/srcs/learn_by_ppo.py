...
def ppo_update(agent, sl_path):
	...
	sl_opti = torch.optim.Adam(agent.policy_model.parameters(), lr=0.0005)
	...
	save_path = '../models/new_alternate_from_scratch' + str(args.max_epochs) + '_lr_' + str(args.lr) + '_clip_' + str(args.clip_epsilon) + '.pth'
