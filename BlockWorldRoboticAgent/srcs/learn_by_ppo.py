...
def ppo_update(agent, sl_path):
	...
	save_path = '../models/new_alternate_from_scratch' + str(3) + '_lr_' + str(args.lr) + '_clip_' + str(args.clip_epsilon) + '.pth'
	torch.save(agent.policy_model.state_dict(), save_path)

if __name__ == '__main__':
	agent = Inverse_agent()
	agent.policy_model.cuda()
	ppo_update(agent, '../models/new_from_scratch_ppo_critic_epochs2_lr_0.0001_clip_0.05.pth')
